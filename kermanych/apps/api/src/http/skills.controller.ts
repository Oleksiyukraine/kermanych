...
export class SkillsController {
  ...
  async list(@Param("id") id: string): Promise<ProjectSkillsPayload> {
    ...
    try {
      // The library EDITOR view: this project's own rows, with the repo shadow from its
      // checkout. An unbound project has no checkout to scan; the view then reports none.
