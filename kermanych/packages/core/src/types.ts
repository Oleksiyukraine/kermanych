...
export type Project = { id: string; name: string; localRepoPath: string; workspaceId?: string; color?: string; previewCommand?: string; apiCommand?: string; carryFiles?: string[]; defaultBranch?: string; defaultModel?: string; defaultEffort?: ThinkingLevel; conventions?: string; createdAt: string };
