...
export const DEFAULT_SKILLS: readonly SkillDef[] = [
  ...
  },
  {
    name: "librarian",
    description:
      "Use during development to keep the project's documentation current, and to track which docs you read and which you create or update — so the report Kermanych attaches to the task at pull-request time is accurate.",
    body: [
      "# Keeping the project's documentation current",
      "",
      "You are the documentation conscience for this change. Two jobs.",
      "",
      "## 1. Write docs as you work",
      "",
      ...
      "",
      "## 2. Track what you touch",
      "",
      "- Keep note of the documentation you READ to understand the change and the docs you",
      "  CREATE or UPDATE, with repo-relative paths. Kermanych asks for this report when the pull",
      "  request is opened and attaches it to the task; your job here is to make it accurate and",
      "  complete — a short note per file on what it is or what changed.",
    ].join("\n"),
  },
];
