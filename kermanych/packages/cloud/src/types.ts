...
// 20260830120000_project_risks.sql one label for one label; the UI's labels and scoring
// policy live in apps/ui/src/lib/risk.ts, because they are copy and project policy, not
// storage.
