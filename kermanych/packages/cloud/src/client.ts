...
// RLS, the sole authorization surface: every request runs under the user's own
// JWT, an anonymous read of any of the five tables is refused with `42501
// permission denied`, and per-project policies isolate each user to the projects
// they own or are a member of. Sign-in is open — any GitHub account may create an
// account — so there is no allowlist to keep. The dashboard's secret key
